...
class BlockRenderer
{
    ...
    private function homeUnifiedSearch(array $p, array $context): string
    {
        ...
        $out .= '<style>'
            ...
            . '.rg-uss__alt{flex:0 0 auto;display:inline-flex;align-items:center;gap:.5rem;padding:.85rem 1.4rem;margin-left:.35rem;font-size:.95rem;font-weight:700;color:#fff;background:#0f172a;border:0;cursor:pointer;border-radius:999px;transition:all .18s ease;white-space:nowrap;letter-spacing:.01em}'
            . '@media(min-width:768px){.rg-uss__alt{padding:1rem 1.6rem;font-size:1rem}}'
            . '.rg-uss__alt:hover{transform:translateY(-1px) scale(1.02);box-shadow:0 12px 24px -8px rgba(15,23,42,.5);background:#1e293b}'
