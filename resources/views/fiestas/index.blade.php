...
@section('title', 'Philippine Fiestas — Calendar by Region · Resort Guru PH')
@section('meta')
    <meta name="description" content="Every major and regional fiesta in the Philippines, organized by region. From Sinulog to MassKara, Panagbenga to Kadayawan — when they happen, why to go, and what makes each one different.">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
    ...
    {{-- Page header --}}
    <header class="mb-10">
        <div class="text-[11px] uppercase tracking-[0.2em] font-bold text-emerald-700 mb-2">Activities</div>
        ...
        <p class="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-3xl">
            Every regional and provincial fiesta on one page. {{ $totalCount }} celebrations across the archipelago, organized by region so you can plan a year around them.
        </p>
    </header>
